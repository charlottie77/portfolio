<template>
  <div id="on-top-tools-container">
    ...
    <div id="topbar" :class="{blur:sTop>heightToShow}">
      ...
      <div id="navigator">
        <span class='active' @click="backToMain()">Work</span><span @click="gotoUrl('/about')">About</span><div> </div>
      </div>
    </div>
  </div>
</template>
...
<script>
export default {
  props:['themeColor','heightToShow','navOnly'],
  data: ()=>({
