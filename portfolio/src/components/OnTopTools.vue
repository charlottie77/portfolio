  ...
  <div id="on-top-tools-container">
    ...
    <div id="topbar">
      <div id="tohome" @click="backToMain()">
        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg" id='topbar-point'>
        ...
        <span :style="{color:themeColor}">Yuqing</span>
      </div>
      <div id="navigator">
        <span class='active'>Work</span><span>About</span><div> </div>
      </div>
    </div>
  </div>
</template>
